...
public class CategoryGridItemAdapter extends RecyclerView.ViewHolder {
    ...
    public void setup(Context context, Product product, int position, List<OCRToDigitalMedicineResponse> datalist, CartCountListener cartCountListener,CheckOutData checkOutData) {
        this.checkOutData=checkOutData;
        setClickListeners(product, context, position, datalist, cartCountListener,checkOutData);
        String string = "\u20B9";
        byte[] utf8 = null;
        try {
...
//                    inc_dec_card.setVisibility(View.VISIBLE);
    ...
    private void setClickListeners(Product product, Context context, int position, List<OCRToDigitalMedicineResponse> datalist, CartCountListener cartCountListener,CheckOutData checkOutData) {

        addToCartLayout.setOnClickListener(v -> {

            ItemBatchSelectionDilaog itemBatchSelectionDilaog = new ItemBatchSelectionDilaog(product, context, position, datalist, cartCountListener);
