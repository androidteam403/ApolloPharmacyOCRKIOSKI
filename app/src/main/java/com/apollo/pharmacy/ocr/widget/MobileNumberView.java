...
import com.apollo.pharmacy.ocr.interfaces.OnOtpListener;


public class MobileNumberView extends AppCompatEditText {
    ...
    public MobileNumberView(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, R.attr.otpViewStyle);
    }

    public MobileNumberView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    protected void onTextChanged(CharSequence text, int start, int lengthBefore, int lengthAfter) {
        ...
        if (text.length() == otpViewItemCount && onOtpListener != null) {
            onOtpListener.onOtpCompleted(text.toString());
        }
        makeBlink();
    ...
    public void setOtpCompletionListener(OnOtpListener otpCompletionListener) {
        this.onOtpListener = otpCompletionListener;
    }
