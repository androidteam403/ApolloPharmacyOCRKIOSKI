...
/**
 * Created by Rakesh on 25/06/19.
 */

public class MarqueeViewRight extends View {
    ...
    public MarqueeViewRight(Context context, AttributeSet attrs, int defStyleAttr) {
