...
public class CalculatePosTransactionResponse {
    ...
    @Expose
    private List<CalculatePosTransactionRequest.SalesLine> salesLine = null;
    ...
    public List<CalculatePosTransactionRequest.SalesLine> getSalesLine() {
        return salesLine;
    }

    public void setSalesLine(List<CalculatePosTransactionRequest.SalesLine> salesLine) {
