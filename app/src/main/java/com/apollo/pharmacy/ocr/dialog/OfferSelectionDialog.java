...
public class OfferSelectionDialog implements DialogOffersSelectionAdapter.ContinueEnablingHandlings {
    ...
    Context context;
    List<GroupOffersModelResponse.Offer.PromoItem> promoItemList;
private GroupOffersModelResponse.Offer offer;
    public OfferSelectionDialog(Context context, GroupOffersModelResponse.Offer offer, List<GroupOffersModelResponse.Offer.PromoItem> promoItemList, Activity activity, MyOffersListener myOffersListener) {
        ...
        DialogOffersSelectionAdapter adapter = new DialogOffersSelectionAdapter(activity, promoItemList, myOffersListener, offer,this);
        offersSelcetionBinding.selectionoffersRecycle.setLayoutManager(new GridLayoutManager(context, screeSize()));
