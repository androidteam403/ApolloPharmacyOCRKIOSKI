...
public class MyOrderTrackInfoAdapter extends RecyclerView.Adapter<MyOrderTrackInfoAdapter.MyViewHolder> {
    private Context mContext;
    private LayoutInflater inflater;
    private List<OCRToDigitalMedicineResponse> ordersList;

    public MyOrderTrackInfoAdapter(Context context, List<OCRToDigitalMedicineResponse> ordersList) {
        mContext = context;
    ...
    @NotNull
    @Override
    public MyOrderTrackInfoAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.view_order_track_infoitem, parent, false);
        return new MyOrderTrackInfoAdapter.MyViewHolder(itemView);
    }
    ...
    @Override
    public void onBindViewHolder(MyOrderTrackInfoAdapter.MyViewHolder holder, int position) {
